...
接著客戶告訴我她也進行了解決方案二，嘗試了各種設定組合之後，還是沒有辦法達到我們想要的結果。這也是我們可以預期的，因為我其中一個微軟的同事早已告訴我，解決方案二不可能會成功，這點只是應證了他的理論而已。(在我之前給客戶的 email 中，我已經表明這點。但由於客戶真的不想走選項三，所以我建議她我們還是先試試選項二，說不定會有奇蹟出現? 哈哈)
